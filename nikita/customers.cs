...
namespace nikita
{
    public partial class customers : Form
    {
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            var first_name = firstname_cust_txt.Text;
            var last_name = lastname_cust_txt.Text;
            var phone = phone_cust_txt.Text;
            try
            {
                string sqlcommand = "UPDATE customers SET first_name = @first_name, last_name = @last_name, phone_number = @phone_number WHERE Id = @Id";
                SqlCommand command = conn.CreateCommand();
